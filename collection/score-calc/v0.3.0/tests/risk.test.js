const riskScore = require('../src/index');
...
describe("CVD Risk Score", ()=>{
  test('male high risk', ()=>{
    ...
    expect(riskScore.score({"age":65,"gender":"male","risk":"high","sbp":180,"cholesterol":8,"smoker":1}).cvdrisk.total).toEqual(expectedscore)
  })
})
